...
from updater import check_for_update, cleanup_old_backups, CURRENT_VERSION
...
class MainWindow(QMainWindow):
    ...
    def _show_menu(self):
        ...
        #Auto-check for updates (silent — only shows dialog if update found)
        QTimer.singleShot(2000, lambda: check_for_update(self._menu, silent=True))
