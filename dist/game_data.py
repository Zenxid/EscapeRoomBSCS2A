...
DIFFICULTIES = {
    "easy": {
        "label":       "EASY",
        "desc":        "Full hints shown. More time. Bonus XP reduced.",
        "time_limit":  1200,   # 20 minutes
        "xp_escape":   200,
        "xp_per_puzzle": 15,
        "xp_per_room": 25,
        "hint_level":  "full",     # full hints always shown
        "color":       "#4a8a4a",
    },
    "normal": {
        "label":       "NORMAL",
        "desc":        "Standard hints. 15 minutes. Balanced XP.",
        "time_limit":  900,    # 15 minutes
        "xp_escape":   400,
        "xp_per_puzzle": 25,
        "xp_per_room": 50,
        "hint_level":  "partial",  # hints shown but no direct answers
        "color":       "#d4a853",
    },
    "hard": {
        "label":       "HARD",
        "desc":        "Minimal hints. 10 minutes. High XP reward.",
        "time_limit":  600,    # 10 minutes
        "xp_escape":   800,
        "xp_per_puzzle": 50,
        "xp_per_room": 100,
        "hint_level":  "minimal",  # just a nudge
        "color":       "#aa4a4a",
    },
    "nightmare": {
        "label":       "NIGHTMARE",
        "desc":        "No hints. 7 minutes. Maximum XP. You're on your own.",
        "time_limit":  420,    # 7 minutes
        "xp_escape":   1500,
        "xp_per_puzzle": 100,
        "xp_per_room": 200,
        "hint_level":  "none",     # hint button disabled
        "color":       "#7a5ab0",
    },
}
